...
1. Never launch a headless browser
2. Assume there is a Chrome browser already listening. Connect to it with `agent-browser connect http://localhost:9222`
3. If you can't connect to such a browser, STOP and notify the user
4. Don't try to diagnose the problem, just STOP
